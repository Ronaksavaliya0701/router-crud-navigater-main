  ...
  return (
        ...
        <Container>
                <Row className='align-items-center'>
                    ...
                    <Col className='col-6'>
                    <img src="https://akm-img-a-in.tosshub.com/businesstoday/images/story/202301/workplace_1-sixteen_nine.jpg?size=1200:675?w=360" className="Img" alt="" />
                    </Col>
